...
const Women = ({products, loading, cartAddItem}) => {
	...
	const category = products.filter((filter) =>{
		return filter.category === "women's clothing";
	});
	...
	return(
		<>
			...
			<Paginate productsPerPage={productsPerPage} totalProducts={category.length} showPagination={category.length} paginate={paginate} />
